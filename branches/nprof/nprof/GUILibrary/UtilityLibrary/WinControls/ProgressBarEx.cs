...
namespace UtilityLibrary.WinControls
{
	...
	public class ProgressBarEx : System.Windows.Forms.Control
	{
		...
		{
			InitializeProgressControl(ProgressBarType.Standard, ColorUtil.VSNetStripeColor, 
				SystemColors.Highlight, SystemColors.Highlight, null, null, Color.Empty, Color.Empty, Color.Empty);
		}

		public ProgressBarEx(Bitmap foregroundBitmap, Bitmap backgroundBitmap)
		{
			InitializeProgressControl(ProgressBarType.Bitmap, ColorUtil.VSNetStripeColor, 
		...
		{
			InitializeProgressControl(ProgressBarType.Gradient, ColorUtil.VSNetStripeColor, 
				SystemColors.Highlight, SystemColors.Highlight, 
