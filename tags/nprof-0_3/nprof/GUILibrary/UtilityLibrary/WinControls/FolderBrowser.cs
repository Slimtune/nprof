...
namespace UtilityLibrary.WinControls
{
	...
	public class ShellFolderBrowser : System.ComponentModel.Component
	{
		...
		private bool ShowDialogInternal(ref BrowseInfo bi)
		{
			...
			bi.flags = (int)flags;
//			if ( _strFolderPath != null )
//				bi.lparam = Marshal.StringToHGlobalAuto( _strFolderPath );
...
//				Marshal.FreeHGlobal( bi.lparam );
		...
		public void SetSelection(string newsel)
		{
			...
			int msg = (Environment.OSVersion.Platform == PlatformID.Win32NT) ? BFFM_SETSELECTIONW : BFFM_SETSELECTIONA;
