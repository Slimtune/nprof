...
namespace UtilityLibrary.WinControls
{
	...
	public class CustomColorDlg : System.Windows.Forms.Form
	{
		...
		private void LumBox_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
		...
		private void lumBox_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		private void lumBox_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			lumBox.Capture = false;
			LuminosityChanged();
		}

		private void lumBox_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			lumBox.Capture = true;
			int y  = e.Y;
			if ( y < 5 ) y = 5;
		...
		private void LuminosityChanged()
		{
		...
		private void HueSatTextBoxChanged()
		{
		...
		private void ConvertToRGB(float h, float s, float l)
		{
		...
		private void CalculatePaletteMarkerCoordinates( int Hue, int Sat)
		{
		...
		private void paletteBox_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		private void paletteBox_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		private void paletteBox_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		private void paletteBox_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
		...
		private void hueEdit_TextChanged(object sender, System.EventArgs e)
		{
			if ( !updatingUI )
				HueSatTextBoxChanged();
		}

		private void satEdit_TextChanged(object sender, System.EventArgs e)
		{
			if ( !updatingUI )
				HueSatTextBoxChanged();
		}

		private void lumEdit_TextChanged(object sender, System.EventArgs e)
		{
			if ( !updatingUI )
				LuminosityChanged();
		}

		private void redEdit_TextChanged(object sender, System.EventArgs e)
		{
			if ( !updatingUI )
				RGBTextChanged();
		}

		private void greenEdit_TextChanged(object sender, System.EventArgs e)
		{
			if ( !updatingUI )
				RGBTextChanged();
		}

		private void blueEdit_TextChanged(object sender, System.EventArgs e)
		{
			if ( !updatingUI )
				RGBTextChanged();
		}
